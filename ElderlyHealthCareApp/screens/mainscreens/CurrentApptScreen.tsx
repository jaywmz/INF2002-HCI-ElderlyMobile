...
const CurrentApptScreen = ({ navigation }) => {
  ...
  const updateAppointment = (index, newAppointment) => {
          ...
          <View key={index} style={styles.appointmentContainer}>
            ...
            <View style={styles.buttonContainer}>
              <TouchableOpacity
                style={styles.button}
                onPress={() =>
                  navigation.navigate('EditYourApptScreen', {
                    appointment,
                    onSave: (newAppointment) => updateAppointment(index, newAppointment),
                  })
                }
              >
